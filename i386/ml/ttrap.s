...
skip_dbreg_save:
	...
	movl	u_debugreg,%eax
	movl	%eax,%db0
	movl	u_debugreg+4,%eax
	movl	%eax,%db1
	movl	u_debugreg+8,%eax
	movl	%eax,%db2
	movl	u_debugreg+12,%eax
	movl	%eax,%db3
	subl	%eax,%eax
	movl	%eax,%db6
	movl	u_debugreg+28,%eax
	movl	%eax,%db7
...
/* GP violation on the iret. */
	movb	$1, u_sigfault    # catch signal processing GP faults
