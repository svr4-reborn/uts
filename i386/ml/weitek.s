...
/* actual or intended publication of such source code. */
...
#ifdef WEITEK
	.set	ARG1,		8
	.set	WEITEK_MMIO_BASE,	0xffc00000	# Virtual address of Weitek
	...
	.set	WEITEK_AE_MASK,		0x000000FD	# Accum. Exception bits mask
	.set	WEITEK_AE_SHIFT,	16		# shift to move accum.
/* exception byte to exception */
/* mask */
	.set	NOT_PCR_INTR,	0xFFFFFFFD	# Everything except interrupt
	.set	WEITEK_20MHZ_FLAG,	0x00008000	# Bit which is set to indicate
/* 20 MHz 1163 chip */
...
reset_weitek_intr:
	pushl	%edi
	movl	$WEITEK_MMIO_BASE, %edi
	movl	WEITEK_STCTX_O(%edi), %eax	# Read context register to
/* quiesce the chip. */
	andl	$WEITEK_AE_MASK, %eax			# Select the accumulated
/* exception bits only */
	shll	$WEITEK_AE_SHIFT, %eax		# Move this bits to the
/* exception mask. */
