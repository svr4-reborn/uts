...
/* CATCH_FAULTS(CATCH_UFAULT) */
	movl	$CATCH_UFAULT, u_fault_catch+fc_flags
	...
	movl	$gpfetch_done, u_fault_catch+fc_func
...
/* Page fault possible here on some branches.  Could separate them. */
	movl    $go_ECT_done,u_fault_catch+fc_func
	movb    $OP_ARPL,(%eax)                 # Plant bad opcode

go_ECT_done:
	movl	$fc_jmpjmp, u_fault_catch+fc_func	# Reset standard
/* fault handler */
	lidt    idtdsc2
	popl    %ebp
	popl	%edx
...
op_cli:
	...
	movl	$op_cli_done,u_fault_catch+fc_func
...
op_sti:
	lidt    idtdsc1                 #  Set IDT for kernel operations
	incw    OLDEIP(%ebp)            # Pass opcode on return
	movl	$op_sti_done,u_fault_catch+fc_func
...
pushf_done1:
	movl    $pushf_done2,u_fault_catch+fc_func
...
op_int:
	...
	movl    $int_done,u_fault_catch+fc_func  #  Next byte could be
/* in next page */
...
int_done1:
	...
	movl	$int_done2,u_fault_catch+fc_func
	movl	$0,(%edx)
int_done2:
	movl    $int_done,u_fault_catch+fc_func
